      ...
      <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="POST" action="{{route('product.update',$product->id)}}">
        ...
        @method('PUT')
          <div class="item form-group">
            ...
            <input type="text" id="name" value="{{$product->name}}" name="name" required="required" class="form-control ">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
            <input type="text" id="name" value="{{$product->slug}}" name="name" required="required" class="form-control ">
            </div>
          </div>
